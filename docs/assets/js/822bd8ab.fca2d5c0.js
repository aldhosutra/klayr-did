    ...
    876: (t, e, r) => {
        ...
        var r,
          ...
          n = (function (t, e) {
            ...
            var r,
              ...
              n = {},
              o = Object.keys(t);
            for (a = 0; a < o.length; a++) (r = o[a]), e.indexOf(r) >= 0 || (n[r] = t[r]);
            return n;
          })(t, e);
        if (Object.getOwnPropertySymbols) {
      ...
      var u = a.createContext({}),
        ...
        m = a.forwardRef(function (t, e) {
          var r = t.components,
            ...
            p = c(r),
            m = n,
            f = p[''.concat(u, '.').concat(m)] || p[m] || d[m] || o;
          return r
      ...
      function f(t, e) {
        ...
        if ('string' == typeof t || n) {
          ...
          (i.originalType = t), (i[p] = 'string' == typeof t ? t : n), (s[1] = i);
    ...
    8515: (t, e, r) => {
      ...
      const o = { sidebar_position: 6 },
        ...
        i = {
          ...
          previous: { title: 'Deploy your site', permalink: '/docs/tutorial-basics/deploy-your-site' },
          next: { title: 'Tutorial - Extras', permalink: '/docs/category/tutorial---extras' },
        },
        u = {},
      ...
      function d(t) {
        ...
        return (0, n.kt)(
          ...
          (0, n.kt)('p', null, 'Docusaurus has ', (0, n.kt)('strong', { parentName: 'p' }, 'much more to offer'), '!'),
          (0, n.kt)(
            'p',
            null,
            'Have ',
            ...
            (0, n.kt)(
              ...
              (0, n.kt)(
                'a',
                { parentName: 'strong', href: '/docs/tutorial-extras/manage-docs-versions' },
                'versioning',
              ),
            ),
            ' and ',
            (0, n.kt)(
              'strong',
              { parentName: 'p' },
              (0, n.kt)('a', { parentName: 'strong', href: '/docs/tutorial-extras/translate-your-site' }, 'i18n'),
            ),
            '.',
          ),
          (0, n.kt)(
            ...
            (0, n.kt)(
              'a',
              { parentName: 'p', href: 'https://github.com/facebook/docusaurus/discussions/4610' },
              'Please report it!',
            ),
          ),
          ...
          (0, n.kt)(
            ...
            (0, n.kt)(
              ...
              { parentName: 'ul' },
              'Read the ',
              (0, n.kt)('a', { parentName: 'li', href: 'https://docusaurus.io/' }, 'official documentation'),
            ),
            (0, n.kt)(
              'li',
              { parentName: 'ul' },
              ...
              (0, n.kt)(
                'a',
                { parentName: 'li', href: 'https://docusaurus.io/docs/api/docusaurus-config' },
                (0, n.kt)('inlineCode', { parentName: 'a' }, 'docusaurus.config.js'),
              ),
            ),
            (0, n.kt)(
              'li',
              ...
              (0, n.kt)(
                'a',
                { parentName: 'li', href: 'https://docusaurus.io/docs/api/themes/configuration' },
            ...
            (0, n.kt)(
              ...
              (0, n.kt)(
                'a',
                { parentName: 'li', href: 'https://docusaurus.io/docs/styling-layout' },
                'Design and Layout',
              ),
            ),
            (0, n.kt)(
              ...
              { parentName: 'ul' },
              'Add a ',
              (0, n.kt)('a', { parentName: 'li', href: 'https://docusaurus.io/docs/search' }, 'search bar'),
            ),
            (0, n.kt)(
              'li',
              { parentName: 'ul' },
              'Find inspirations in the ',
              (0, n.kt)('a', { parentName: 'li', href: 'https://docusaurus.io/showcase' }, 'Docusaurus showcase'),
            ),
            (0, n.kt)(
              'li',
              { parentName: 'ul' },
              ...
              (0, n.kt)(
                'a',
                { parentName: 'li', href: 'https://docusaurus.io/community/support' },
