  ...
  [9414],
  {
    ...
    9414: (e, t, n) => {
      ...
      function v(e, t) {
        ...
        const c = (function (e, t) {
            switch (e) {
              ...
              case 'ts':
              case 'typescript':
                return b(['js', 'jsBlock'], t);
              case 'jsx':
              case 'tsx':
                return b(['js', 'jsBlock', 'jsx'], t);
              case 'html':
                return b(['js', 'jsBlock', 'html'], t);
              case 'python':
              case 'py':
              case 'bash':
                return b(['bash'], t);
              case 'markdown':
              case 'md':
                return b(['html', 'jsx', 'bash'], t);
              default:
                return b(Object.keys(y), t);
            }
          })(o, r),
          l = n.split('\n'),
          ...
          e.apply(this, n),
            ...
            L(this, 'getLineProps', function (e) {
              var n = e.key,
                o = e.className,
                r = e.style,
                a = O({}, P(e, ['key', 'className', 'style', 'line']), {
            ...
            L(this, 'getTokenProps', function (e) {
              var n = e.key,
                ...
                r = e.style,
                a = e.token,
                c = O({}, P(e, ['key', 'className', 'style', 'token']), {
                ...
                for (var t = [[]], n = [e], o = [0], r = [e.length], a = 0, c = 0, l = [], i = [l]; c > -1; ) {
                  for (; (a = o[c]++) < r[c]; ) {
                    ...
                    if (
                      ('string' == typeof m
                        ? ((u = c > 0 ? u : ['plain']), (s = m))
                        : ((u = _(u, m.type)), m.alias && (u = _(u, m.alias)), (s = m.content)),
                      'string' == typeof s)
                    ) {
                      var d = s.split(x),
                        p = d.length;
                      l.push({ types: u, content: d[0] });
                      for (var f = 1; f < p; f++) S(l), i.push((l = [])), l.push({ types: u, content: d[f] });
      ...
      function D(e) {
        ...
        const s = c({ line: t, className: (0, i.Z)(n, r && I.codeLine) }),
        ...
        return o.createElement(
          ...
          r
            ? o.createElement(
                o.Fragment,
                null,
                o.createElement('span', { className: I.codeLineNumber }),
                o.createElement('span', { className: I.codeLineContent }, u),
              )
            : u,
        ...
        return (
          ...
          o.createElement(
            'button',
            {
              ...
              className: (0, i.Z)('clean-btn', n, V.copyButton, r && V.copyButtonCopied),
              onClick: l,
            },
            o.createElement(
              'span',
              { className: V.copyButtonIcons, 'aria-hidden': 'true' },
              o.createElement(H, { className: V.copyButtonIcon }),
              o.createElement(W, { className: V.copyButtonSuccessIcon }),
            ),
          )
        );
      }
      ...
      function G(e) {
        ...
        const {
          ...
          { lineClassNames: E, code: C } = v(t, { metastring: r, language: f, magicComments: p }),
          B =
            l ??
            (function (e) {
        ...
        return o.createElement(
          ...
          b && o.createElement('div', { className: N.codeBlockTitle }, b),
          o.createElement(
            'div',
            { className: N.codeBlockContent },
            o.createElement(A, (0, a.Z)({}, j, { theme: g, code: C, language: f ?? 'text' }), e => {
              ...
              return o.createElement(
                ...
                o.createElement(
                  'code',
                  { className: (0, i.Z)(N.codeBlockLines, B && N.codeBlockLinesWithNumbering) },
                  n.map((e, t) =>
                    o.createElement(D, {
                      key: t,
                      line: e,
            ...
            o.createElement(
              ...
              o.createElement(R, { className: N.codeButton, code: C }),
            ),
          ),
        );
      }
      function Y(e) {
        ...
        const r = (0, l.Z)(),
          ...
          i = 'string' == typeof c ? G : C;
        return o.createElement(i, (0, a.Z)({ key: String(r) }, n), c);
      }
      var J = n(9817);
      var Q = n(8698);
      const U = { details: 'details_B4FW', isBrowser: 'isBrowser_Cof9', collapsibleContent: 'collapsibleContent_VYua' };
      function X(e) {
      ...
      function ee(e) {
        ...
        const c = (0, l.Z)(),
          s = (0, o.useRef)(null),
          { collapsed: u, setCollapsed: m } = (0, Q.u)({ initialState: !r.open }),
        ...
        return o.createElement(
          ...
          (0, a.Z)({}, r, {
            ...
            open: d,
            'data-collapsed': u,
            className: (0, i.Z)(U.details, c && U.isBrowser, r.className),
            onMouseDown: e => {
          ...
          o.createElement(
            ...
            o.createElement('div', { className: U.collapsibleContent }, n),
          ),
        );
      }
