...
(self.webpackChunklisk_did_docs = self.webpackChunklisk_did_docs || []).push([
  [6755],
  {
    876: (e, t, n) => {
      ...
      function f(e, t) {
        ...
        if ('string' == typeof e || a) {
          ...
          (i.originalType = e), (i[d] = 'string' == typeof e ? e : a), (l[1] = i);
          for (var u = 2; u < o; u++) l[u] = n[u];
    ...
    7929: (e, t, n) => {
      ...
      const o = { sidebar_position: 2 },
        ...
        i = {
          ...
          previous: { title: 'Manage Docs Versions', permalink: '/docs/tutorial-extras/manage-docs-versions' },
        },
        s = {},
        u = [
      ...
      function p(e) {
        ...
        return (0, a.kt)(
          ...
          (0, a.kt)(
            ...
            null,
            'Modify ',
            (0, a.kt)('inlineCode', { parentName: 'p' }, 'docusaurus.config.js'),
          ...
          (0, a.kt)(
            ...
            null,
            'Translate ',
            (0, a.kt)('inlineCode', { parentName: 'p' }, 'i18n/fr/docusaurus-plugin-content-docs/current/intro.md'),
            ' in French.',
          ),
          (0, a.kt)('h2', { id: 'start-your-localized-site' }, 'Start your localized site'),
          (0, a.kt)('p', null, 'Start your site on the French locale:'),
          (0, a.kt)(
            'pre',
            null,
            (0, a.kt)('code', { parentName: 'pre', className: 'language-bash' }, 'npm run start -- --locale fr\n'),
          ),
          (0, a.kt)(
            'p',
            null,
            'Your localized site is accessible at ',
            (0, a.kt)('a', { parentName: 'p', href: 'http://localhost:3000/fr/' }, 'http://localhost:3000/fr/'),
            ' and the ',
          ...
          (0, a.kt)(
            'admonition',
            { type: 'caution' },
            (0, a.kt)('p', { parentName: 'admonition' }, 'In development, you can only use one locale at a same time.'),
          ),
          (0, a.kt)('h2', { id: 'add-a-locale-dropdown' }, 'Add a Locale Dropdown'),
          (0, a.kt)('p', null, 'To navigate seamlessly across languages, add a locale dropdown.'),
          (0, a.kt)(
            'p',
            null,
            'Modify the ',
          ...
          (0, a.kt)('p', null, 'The locale dropdown now appears in your navbar:'),
          (0, a.kt)(
            'p',
            null,
            (0, a.kt)('img', { alt: 'Locale Dropdown', src: n(2313).Z, width: '370', height: '302' }),
          ),
          (0, a.kt)('h2', { id: 'build-your-localized-site' }, 'Build your localized site'),
          (0, a.kt)('p', null, 'Build your site for a specific locale:'),
          (0, a.kt)(
            'pre',
            null,
            (0, a.kt)('code', { parentName: 'pre', className: 'language-bash' }, 'npm run build -- --locale fr\n'),
          ),
          (0, a.kt)('p', null, 'Or build your site to include all the locales at once:'),
          (0, a.kt)(
            'pre',
            null,
            (0, a.kt)('code', { parentName: 'pre', className: 'language-bash' }, 'npm run build\n'),
          ),
        );
      }
      p.isMDXComponent = !0;
    ...
    2313: (e, t, n) => {
      n.d(t, { Z: () => r });
      const r = n.p + 'assets/images/localeDropdown-f0d995e751e7656a1b0dbbc1134e49c2.png';
    },
  },
]);
