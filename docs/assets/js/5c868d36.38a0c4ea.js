    ...
    876: (e, t, a) => {
      ...
      var c = r.createContext({}),
        ...
        m = r.forwardRef(function (e, t) {
          var a = e.components,
            ...
            u = s(a),
            m = n,
            g = u[''.concat(c, '.').concat(m)] || u[m] || d[m] || o;
          return a
            ? r.createElement(g, i(i({ ref: t }, p), {}, { components: a }))
      ...
      function g(e, t) {
        ...
        if ('string' == typeof e || n) {
          ...
          (l.originalType = e), (l[u] = 'string' == typeof e ? e : n), (i[1] = l);
          for (var s = 2; s < o; s++) i[s] = a[s];
    ...
    2447: (e, t, a) => {
      ...
      const o = { sidebar_position: 1 },
        ...
        l = {
          ...
          previous: { title: 'Tutorial - Basics', permalink: '/docs/category/tutorial---basics' },
          next: { title: 'Create a Document', permalink: '/docs/tutorial-basics/create-a-document' },
        },
        c = {},
        s = [
        ...
        return (0, n.kt)(
          ...
          (0, n.kt)(
            ...
            (0, n.kt)(
              'li',
              { parentName: 'ul' },
              (0, n.kt)('inlineCode', { parentName: 'li' }, 'src/pages/index.js'),
              ' \u2192 ',
            ...
            (0, n.kt)(
              ...
              ' \u2192 ',
              (0, n.kt)('inlineCode', { parentName: 'li' }, 'localhost:3000/foo'),
            ),
            (0, n.kt)(
              'li',
              { parentName: 'ul' },
              (0, n.kt)('inlineCode', { parentName: 'li' }, 'src/pages/foo/bar.js'),
              ' \u2192 ',
              (0, n.kt)('inlineCode', { parentName: 'li' }, 'localhost:3000/foo/bar'),
            ),
          ),
          (0, n.kt)('h2', { id: 'create-your-first-react-page' }, 'Create your first React Page'),
          (0, n.kt)(
            'p',
            null,
            'Create a file at ',
            (0, n.kt)('inlineCode', { parentName: 'p' }, 'src/pages/my-react-page.js'),
            ':',
          ),
          (0, n.kt)(
            'pre',
          ...
          (0, n.kt)('h2', { id: 'create-your-first-markdown-page' }, 'Create your first Markdown Page'),
          (0, n.kt)(
            'p',
            null,
            'Create a file at ',
            (0, n.kt)('inlineCode', { parentName: 'p' }, 'src/pages/my-markdown-page.md'),
            ':',
          ),
          (0, n.kt)(
            'pre',
          ...
          (0, n.kt)(
            ...
            (0, n.kt)(
              'a',
              { parentName: 'p', href: 'http://localhost:3000/my-markdown-page' },
