    ...
    876: (e, t, r) => {
      ...
      function b(e, t) {
        ...
        if ('string' == typeof e || n) {
          ...
          (l.originalType = e), (l[p] = 'string' == typeof e ? e : n), (i[1] = l);
    ...
    8712: (e, t, r) => {
      ...
      const o = { sidebar_position: 2 },
        ...
        l = {
          ...
          previous: { title: 'Create a Page', permalink: '/docs/tutorial-basics/create-a-page' },
          next: { title: 'Create a Blog Post', permalink: '/docs/tutorial-basics/create-a-blog-post' },
        },
        s = {},
        c = [
      ...
      function d(e) {
        ...
        return (0, n.kt)(
          ...
          (0, n.kt)(
            'ul',
            null,
            (0, n.kt)('li', { parentName: 'ul' }, 'a ', (0, n.kt)('strong', { parentName: 'li' }, 'sidebar')),
            (0, n.kt)(
              'li',
              { parentName: 'ul' },
              (0, n.kt)('strong', { parentName: 'li' }, 'previous/next navigation'),
            ),
            (0, n.kt)('li', { parentName: 'ul' }, (0, n.kt)('strong', { parentName: 'li' }, 'versioning')),
          ),
          (0, n.kt)('h2', { id: 'create-your-first-doc' }, 'Create your first Doc'),
          (0, n.kt)(
            'p',
            null,
          ...
          (0, n.kt)('h2', { id: 'configure-the-sidebar' }, 'Configure the Sidebar'),
          (0, n.kt)(
            'p',
            null,
          ...
          (0, n.kt)('p', null, 'Add metadata to customize the sidebar label and position:'),
          (0, n.kt)(
            'pre',
            null,
            (0, n.kt)(
