    ...
    876: (e, t, r) => {
      ...
      var l = o.createContext({}),
        ...
        y = o.forwardRef(function (e, t) {
          var r = e.components,
            ...
            c = u(r),
            y = n,
            m = c[''.concat(l, '.').concat(y)] || c[y] || d[y] || a;
          return r
      ...
      function m(e, t) {
        ...
        if ('string' == typeof e || n) {
          ...
          (s.originalType = e), (s[c] = 'string' == typeof e ? e : n), (i[1] = s);
    ...
    9011: (e, t, r) => {
      ...
      const a = { sidebar_position: 5 },
        ...
        s = {
          ...
          previous: { title: 'Markdown Features', permalink: '/docs/tutorial-basics/markdown-features' },
          next: { title: 'Congratulations!', permalink: '/docs/tutorial-basics/congratulations' },
        },
        l = {},
        u = [
      ...
      function d(e) {
        ...
        return (0, n.kt)(
          ...
          (0, n.kt)('h1', { id: 'deploy-your-site' }, 'Deploy your site'),
          (0, n.kt)(
            'p',
            null,
            'Docusaurus is a ',
            (0, n.kt)('strong', { parentName: 'p' }, 'static-site-generator'),
            ' (also called ',
            (0, n.kt)(
              'strong',
              { parentName: 'p' },
              (0, n.kt)('a', { parentName: 'strong', href: 'https://jamstack.org/' }, 'Jamstack'),
            ),
            ').',
          ),
          (0, n.kt)(
            ...
            (0, n.kt)('strong', { parentName: 'p' }, 'static HTML, JavaScript and CSS files'),
            '.',
          ),
          (0, n.kt)('h2', { id: 'build-your-site' }, 'Build your site'),
          (0, n.kt)('p', null, 'Build your site ', (0, n.kt)('strong', { parentName: 'p' }, 'for production'), ':'),
          (0, n.kt)(
            'pre',
            null,
            (0, n.kt)('code', { parentName: 'pre', className: 'language-bash' }, 'npm run build\n'),
          ),
          (0, n.kt)(
            'p',
            null,
            'The static files are generated in the ',
            (0, n.kt)('inlineCode', { parentName: 'p' }, 'build'),
            ' folder.',
          ),
          (0, n.kt)('h2', { id: 'deploy-your-site-1' }, 'Deploy your site'),
          (0, n.kt)('p', null, 'Test your production build locally:'),
          (0, n.kt)(
            'pre',
            null,
            (0, n.kt)('code', { parentName: 'pre', className: 'language-bash' }, 'npm run serve\n'),
          ),
          (0, n.kt)(
            'p',
            null,
            ...
            (0, n.kt)('a', { parentName: 'p', href: 'http://localhost:3000/' }, 'http://localhost:3000/'),
            '.',
          ),
          (0, n.kt)(
            'p',
            ...
            (0, n.kt)('inlineCode', { parentName: 'p' }, 'build'),
            ' folder ',
            (0, n.kt)('strong', { parentName: 'p' }, 'almost anywhere'),
            ' easily, ',
            (0, n.kt)('strong', { parentName: 'p' }, 'for free'),
            ...
            (0, n.kt)(
              ...
              (0, n.kt)(
                'a',
                { parentName: 'strong', href: 'https://docusaurus.io/docs/deployment' },
                'Deployment Guide',
              ),
            ),
            ').',
