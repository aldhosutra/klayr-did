...
(self.webpackChunklisk_did_docs = self.webpackChunklisk_did_docs || []).push([
  [3792],
  {
    876: (e, t, n) => {
      ...
      var l = r.createContext({}),
        ...
        m = r.forwardRef(function (e, t) {
          var n = e.components,
            ...
            p = c(n),
            m = o,
            v = p[''.concat(l, '.').concat(m)] || p[m] || u[m] || a;
          return n
      ...
      function v(e, t) {
        ...
        if ('string' == typeof e || o) {
          ...
          (i.originalType = e), (i[p] = 'string' == typeof e ? e : o), (s[1] = i);
    ...
    6459: (e, t, n) => {
      ...
      const a = { sidebar_position: 1 },
        ...
        i = {
          ...
          previous: { title: 'Tutorial - Extras', permalink: '/docs/category/tutorial---extras' },
          next: { title: 'Translate your site', permalink: '/docs/tutorial-extras/translate-your-site' },
        },
        l = {},
        c = [
      ...
      function u(e) {
        ...
        return (0, o.kt)(
          ...
          (0, o.kt)('h1', { id: 'manage-docs-versions' }, 'Manage Docs Versions'),
          (0, o.kt)('p', null, 'Docusaurus can manage multiple versions of your docs.'),
          (0, o.kt)('h2', { id: 'create-a-docs-version' }, 'Create a docs version'),
          ...
          (0, o.kt)(
            ...
            (0, o.kt)('inlineCode', { parentName: 'p' }, 'versioned_docs/version-1.0'),
            ' and ',
          ...
          (0, o.kt)(
            ...
            (0, o.kt)(
              ...
              ' at ',
              (0, o.kt)('inlineCode', { parentName: 'li' }, 'http://localhost:3000/docs/'),
            ...
            (0, o.kt)(
              ...
              ' at ',
              (0, o.kt)('inlineCode', { parentName: 'li' }, 'http://localhost:3000/docs/next/'),
              ' for the ',
              (0, o.kt)('strong', { parentName: 'li' }, 'upcoming, unreleased docs'),
            ),
          ),
          (0, o.kt)('h2', { id: 'add-a-version-dropdown' }, 'Add a Version Dropdown'),
          (0, o.kt)('p', null, 'To navigate seamlessly across versions, add a version dropdown.'),
          (0, o.kt)(
            'p',
            null,
            'Modify the ',
            (0, o.kt)('inlineCode', { parentName: 'p' }, 'docusaurus.config.js'),
            ' file:',
          ),
          (0, o.kt)(
            'pre',
          ...
          (0, o.kt)('p', null, 'The docs version dropdown appears in your navbar:'),
          (0, o.kt)(
            'p',
            null,
            (0, o.kt)('img', { alt: 'Docs Version Dropdown', src: n(4044).Z, width: '370', height: '302' }),
          ),
          (0, o.kt)('h2', { id: 'update-an-existing-version' }, 'Update an existing version'),
          (0, o.kt)('p', null, 'It is possible to edit versioned docs in their respective folder:'),
          (0, o.kt)(
            'ul',
            null,
            (0, o.kt)(
              'li',
              { parentName: 'ul' },
              (0, o.kt)('inlineCode', { parentName: 'li' }, 'versioned_docs/version-1.0/hello.md'),
              ' updates ',
              (0, o.kt)('inlineCode', { parentName: 'li' }, 'http://localhost:3000/docs/hello'),
            ),
            (0, o.kt)(
              'li',
              { parentName: 'ul' },
              ...
              ' updates ',
              (0, o.kt)('inlineCode', { parentName: 'li' }, 'http://localhost:3000/docs/next/hello'),
            ),
          ),
        );
      }
    ...
    4044: (e, t, n) => {
      n.d(t, { Z: () => r });
      const r = n.p + 'assets/images/docsVersionDropdown-35e13cbe46c9923327f30a76a90bff3b.png';
    },
  },
]);
