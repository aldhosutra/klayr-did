  ...
  [9514, 2006],
  {
    4959: (e, t, n) => {
      ...
      var a = n(2784),
        ...
        b = n(4126),
        p = n(2105);
      const h = { backToTopButton: 'backToTopButton_z1FD', backToTopButtonShow: 'backToTopButtonShow_w1wE' };
      function E() {
        ...
        return a.createElement('button', {
          ...
          className: (0, l.Z)('clean-btn', r.k.common.backToTopButton, h.backToTopButton, e && h.backToTopButtonShow),
          type: 'button',
          onClick: t,
        });
      }
      ...
      const S = {
        collapseSidebarButton: 'collapseSidebarButton_Ftvb',
        collapseSidebarButtonIcon: 'collapseSidebarButtonIcon_c4WT',
      };
      function N(e) {
        let { onClick: t } = e;
        return a.createElement(
          'button',
          {
            ...
            className: (0, l.Z)('button button--secondary button--outline', S.collapseSidebarButton),
            onClick: t,
          },
      ...
      function M(e) {
        ...
        const { items: m, label: u, collapsible: b, className: p, href: h } = t,
          ...
          g = (0, i._F)(t, o),
          k = (0, L.Mg)(h, o),
          { collapsed: _, setCollapsed: I } = (0, y.u)({ initialState: () => !!b && !g && t.collapsed }),
        ...
        return (
          ...
          })({ isActive: g, collapsed: _, updateCollapsed: T }),
          (0, a.useEffect)(() => {
            b && null != S && S !== s && E && I(!0);
          }, [b, S, s, I, E]),
          a.createElement(
            ...
            a.createElement(
              'div',
              { className: (0, l.Z)('menu__list-item-collapsible', { 'menu__list-item-collapsible--active': k }) },
              a.createElement(
                A.Z,
                (0, C.Z)(
                  {
            ...
            a.createElement(
              ...
              a.createElement(U, { items: m, tabIndex: _ ? -1 : 0, onItemClick: n, activePath: o, level: c + 1 }),
            ),
          )
        );
      }
      var P = n(1344),
        W = n(4442);
      const D = { menuExternalLink: 'menuExternalLink_xK2O' };
      function R(e) {
        let { item: t, onItemClick: n, activePath: o, level: c, index: s, ...d } = e;
        ...
        return a.createElement(
          'li',
          {
            className: (0, l.Z)(r.k.docs.docSidebarItemLink, r.k.docs.docSidebarItemLinkLevel(c), 'menu__list-item', b),
            key: u,
          },
          a.createElement(
            A.Z,
            (0, C.Z)(
              {
                className: (0, l.Z)('menu__link', !E && D.menuExternalLink, { 'menu__link--active': h }),
                autoAddBaseUrl: p,
      ...
      const q = { menuHtmlItem: 'menuHtmlItem_anEq' };
      function V(e) {
        ...
        return a.createElement('li', {
          className: (0, l.Z)(
            ...
            i && [q.menuHtmlItem, 'menu__list-item'],
            s,
          ),
          key: o,
      ...
      function z(e) {
        ...
        switch (t.type) {
          case 'category':
            return a.createElement(M, (0, C.Z)({ item: t }, n));
          case 'html':
      ...
      function O(e) {
        ...
        return a.createElement(
          w,
          null,
          t.map((e, t) => a.createElement(z, (0, C.Z)({ key: t, item: e, index: t }, n))),
        );
      }
      const U = (0, a.memo)(O),
        K = { menu: 'menu_qiME', menuWithAnnouncementBar: 'menuWithAnnouncementBar_hRfJ' };
      function Y(e) {
        ...
        return a.createElement(
          'nav',
          {
            ...
            className: (0, l.Z)('menu thin-scrollbar', K.menu, c && K.menuWithAnnouncementBar, o),
          },
          a.createElement(
            'ul',
      ...
      const J = 'sidebar_vJCc',
        G = 'sidebarWithHideableNavbar_Fo4g',
      ...
      function j(e) {
        ...
        return a.createElement(
          'div',
          { className: (0, l.Z)(J, c && G, r && Q) },
          c && a.createElement(_.Z, { tabIndex: -1, className: X }),
      ...
      const re = { expandButton: 'expandButton_qIqc', expandButtonIcon: 'expandButtonIcon_aOpf' };
      function ce(e) {
      ...
      const be = { docPage: 'docPage_pOTq', docsWrapper: 'docsWrapper_BqXd' };
      function pe(e) {
        let { children: t } = e;
        const n = (0, d.V)(),
          [l, o] = (0, a.useState)(!1);
        return a.createElement(
          ...
          a.createElement(
            ...
            n && a.createElement(de, { sidebar: n.items, hiddenSidebarContainer: l, setHiddenSidebarContainer: o }),
