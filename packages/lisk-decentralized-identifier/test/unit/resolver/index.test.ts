...
import { LiskLocalDidDriver, LiskOffChainDidDriver, LiskOnChainDidDriver } from '@dist/resolver/driver';
...
describe('createLocalDriver', () => {
  it('should return correct local driver instance', () => {
    ...
    expect(driver).toBeInstanceOf(LiskLocalDidDriver);
  });
});
...
describe('createOnChainDriver', () => {
  it('should return correct onChain driver instance', () => {
    ...
    expect(driver).toBeInstanceOf(LiskOnChainDidDriver);
  });
});
...
describe('createOffChainDriver', () => {
  it('should return correct off chain driver instance', () => {
    ...
    expect(driver).toBeInstanceOf(LiskOffChainDidDriver);
  });
});
