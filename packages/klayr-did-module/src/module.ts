...
import { BaseModule, ModuleInitArgs, ModuleMetadata, TransactionExecuteContext } from 'klayr-sdk';
...
import { DidModuleConfig } from '@klayr-did/klayr-decentralized-identifier';
