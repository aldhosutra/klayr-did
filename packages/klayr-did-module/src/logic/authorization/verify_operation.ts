import { DidModuleConfig, PayloadWithSignature, client } from '@klayr-did/klayr-decentralized-identifier';
import { MethodContext, CommandVerifyContext, VerifyStatus } from 'klayr-sdk';
