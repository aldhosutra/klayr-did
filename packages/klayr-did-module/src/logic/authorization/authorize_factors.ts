import { AuthorizationFactors, AuthorizationResult, cryptography } from '@klayr-did/klayr-decentralized-identifier';
import { MethodContext, ModuleEndpointContext } from 'klayr-sdk';
