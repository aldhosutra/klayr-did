...
export const customDID = `${utils.constant.KLAYR_DID_PREFIX}:${chainspace}:namespace:custom`;

export const noDocumentDID = `${utils.constant.KLAYR_DID_PREFIX}:${chainspace}:namespace:no-document`;

export const emptyDID = `${utils.constant.KLAYR_DID_PREFIX}:${chainspace}:test:empty`;
